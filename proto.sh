...
protoc-wrapper -I/usr/include \
        --proto_path=src/AccelByte.Extend.Vivox.Authentication.Server/Protos \
        ...
        --go-grpc_opt=paths=source_relative src/AccelByte.Extend.Vivox.Authentication.Server/Protos/*.proto
